...
export function ProjectCard({ data, className }: ProjectCardType) {
  ...
  return (
    <div className={cn("flex flex-col gap-4 w-full select-none", className)}>
      ...
      <div className="group hover:border-slate-300 hover:scale-[99%] duration-300 hover:shadow-md shadow-slate-900 transition-all min-h-80 bg-slate-950 border border-slate-800 rounded-2xl overflow-clip">
        <div className="min-h-56 max-h-56 overflow-clip relative">
